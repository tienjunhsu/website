!function (e, t) {
    ...
    function v(e, t, n, r, i) {
        for (var o, a, s, l, u, c, d, f = e.length, v = p(t), y = [], b = 0; b < f; b++)if (a = e[b], a || 0 === a)if ("object" === pe.type(a))pe.merge(y, a.nodeType ? [a] : a); else if (Ue.test(a)) {
            ...
            if (!de.leadingWhitespace && $e.test(a) && y.push(t.createTextNode($e.exec(a)[0])), !de.tbody)for (a = "table" !== u || Ve.test(a) ? "<table>" !== d[1] || Ve.test(a) ? 0 : l : l.firstChild, o = a && a.childNodes.length; o--;)pe.nodeName(c = a.childNodes[o], "tbody") && !c.childNodes.length && a.removeChild(c);
            for (pe.merge(y, l.childNodes), l.textContent = ""; l.firstChild;)l.removeChild(l.firstChild);
            l = v.lastChild
        } else y.push(t.createTextNode(a));
        for (l && v.removeChild(l), de.appendChecked || pe.grep(h(y, "input"), g), b = 0; a = y[b++];)if (r && pe.inArray(a, r) > -1)i && i.push(a); else if (s = pe.contains(a.ownerDocument, a), l = h(v.appendChild(a), "script"), s && m(l), n)for (o = 0; a = l[o++];)We.test(a.type || "") && n.push(a);
        return l = null, v
    }
    ...
    function N(e, t, n, r) {
        t = oe.apply([], t);
        var i, o, a, s, l, u, c = 0, d = e.length, f = d - 1, p = t[0], m = pe.isFunction(p);
        ...
        if (d && (u = v(t, e[0].ownerDocument, !1, e, r), i = u.firstChild, 1 === u.childNodes.length && (u = i), i || r)) {
            for (s = pe.map(h(u, "script"), C), a = s.length; c < d; c++)o = u, c !== f && (o = pe.clone(o, !0, !0), a && pe.merge(s, h(o, "script"))), n.call(e[c], o, c);
            if (a)for (l = s[s.length - 1].ownerDocument, pe.map(s, E), c = 0; c < a; c++)o = s[c], We.test(o.type || "") && !pe._data(o, "globalEval") && pe.contains(l, o) && (o.src ? pe._evalUrl && pe._evalUrl(o.src) : pe.globalEval((o.text || o.textContent || o.innerHTML || "").replace(ot, "")));
            u = i = null
        }
        return e
    }
    ...
    function q(e, t) {
        for (var n, r, i, o = [], a = 0, s = e.length; a < s; a++)r = e[a], r.style && (o[a] = pe._data(r, "olddisplay"), n = r.style.display, t ? (o[a] || "none" !== n || (r.style.display = ""), "" === r.style.display && Me(r) && (o[a] = pe._data(r, "olddisplay", A(r.nodeName)))) : (i = Me(r), (n && "none" !== n || !i) && pe._data(r, "olddisplay", i ? n : pe.css(r, "display"))));
    ...
    function R(e, t, n) {
        var r = !0, i = "width" === t ? e.offsetWidth : e.offsetHeight, o = ht(e), a = de.boxSizing && "border-box" === pe.css(e, "boxSizing", !1, o);
        if (i <= 0 || null == i) {
            if (i = mt(e, t, o), (i < 0 || null == i) && (i = e.style[t]), dt.test(i))return i;
    ...
    function I(e, t, n) {
        var r, i, o, a, s, l, u, c, d = this, f = {}, p = e.style, h = e.nodeType && Me(e), m = pe._data(e, "fxshow");
        ...
        })), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [p.overflow, p.overflowX, p.overflowY], u = pe.css(e, "display"), c = "none" === u ? pe._data(e, "olddisplay") || A(e.nodeName) : u, "inline" === c && "none" === pe.css(e, "float") && (de.inlineBlockNeedsLayout && "inline" !== A(e.nodeName) ? p.zoom = 1 : p.display = "inline-block")), n.overflow && (p.overflow = "hidden", de.shrinkWrapBlocks() || d.always(function () {
        ...
        if (pe.isEmptyObject(f))"inline" === ("none" === u ? A(e.nodeName) : u) && (p.display = u); else {
    ...
    function $(e, t, n) {
        var r, i, o = 0, a = $.prefilters.length, s = pe.Deferred().always(function () {
            ...
            if (i)return !1;
            for (var t = kt || M(), n = Math.max(0, u.startTime + u.duration - t), r = n / u.duration || 0, o = 1 - r, a = 0, l = u.tweens.length; a < l; a++)u.tweens[a].run(o);
        ...
        for (W(c, u.opts.specialEasing); o < a; o++)if (r = $.prefilters[o].call(u, e, c, u.opts))return pe.isFunction(r.stop) && (pe._queueHooks(u.elem, u.opts.queue).stop = pe.proxy(r.stop, r)), r;
    ...
    var ne = [], re = e.document, ie = ne.slice, oe = ne.concat, ae = ne.push, se = ne.indexOf, le = {}, ue = le.toString, ce = le.hasOwnProperty, de = {}, fe = "1.12.4", pe = function (e, t) {
    ...
    pe.fn = pe.prototype = {
        ...
        for ("boolean" == typeof a && (u = a, a = arguments[s] || {}, s++), "object" == typeof a || pe.isFunction(a) || (a = {}), s === l && (a = this, s--); s < l; s++)if (null != (i = arguments[s]))for (r in i)e = a[r], n = i[r], a !== n && (u && n && (pe.isPlainObject(n) || (t = pe.isArray(n))) ? (t ? (t = !1, o = e && pe.isArray(e) ? e : []) : o = e && pe.isPlainObject(e) ? e : {}, a[r] = pe.extend(u, o, n)) : void 0 !== n && (a[r] = n));
        return a
    }, pe.extend({
    ...
    var ye = function (e) {
            ...
            if (!r && ((t ? t.ownerDocument || t : B) !== H && L(t), t = t || H, F)) {
                ...
                if (w.qsa && !X[e + " "] && (!_ || !_.test(e))) {
                    if (1 !== m)h = t, p = e; else if ("object" !== t.nodeName.toLowerCase()) {
                        for ((s = t.getAttribute("id")) ? s = s.replace(be, "\\$&") : t.setAttribute("id", s = P), d = k(e), o = d.length, l = fe.test(s) ? "#" + s : "[id='" + s + "']"; o--;)d[o] = l + " " + f(d[o]);
        ...
        function p(e, t, n) {
            ...
            return t.first ? function (t, n, o) {
                ...
                if (a) {
                    ...
                    if (u = t[P] || (t[P] = {}), l = u[t.uniqueID] || (u[t.uniqueID] = {}), (s = l[r]) && s[0] === I && s[1] === o)return c[2] = s[2];
        ...
        function b(e, n) {
            var i = n.length > 0, o = e.length > 0, a = function (r, a, s, l, u) {
                var c, d, f, p = 0, h = "0", m = r && [], v = [], y = j, b = r || o && T.find.TAG("*", u), x = I += null == y ? 1 : Math.random() || .1, w = b.length;
                for (u && (j = a === H || a || u); h !== w && null != (c = b[h]); h++) {
                    if (o && c) {
                        for (d = 0, a || c.ownerDocument === H || (L(c), s = !F); f = e[d++];)if (f(c, a || H, s)) {
                            l.push(c);
                            break
                        }
                        u && (I = x)
        ...
        var x, w, T, C, E, k, S, N, j, D, A, L, H, q, F, _, R, O, M, P = "sizzle" + 1 * new Date, B = e.document, I = 0, W = 0, $ = n(), z = n(), X = n(), U = function (e, t) {
            return e === t && (A = !0), 0
        }, V = 1 << 31, G = {}.hasOwnProperty, Y = [], J = Y.pop, Q = Y.push, K = Y.push, Z = Y.slice, ee = function (e, t) {
        ...
        w = t.support = {}, E = t.isXML = function (e) {
            ...
            return r !== H && 9 === r.nodeType && r.documentElement ? (H = r, q = H.documentElement, F = !E(H), (n = H.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Te, !1) : n.attachEvent && n.attachEvent("onunload", Te)), w.attributes = i(function (e) {
                ...
                }, R = [], _ = [], (w.qsa = ge.test(H.querySelectorAll)) && (i(function (e) {
            ...
            })), (w.matchesSelector = ge.test(O = q.matches || q.webkitMatchesSelector || q.mozMatchesSelector || q.oMatchesSelector || q.msMatchesSelector)) && i(function (e) {
                w.disconnectedMatch = O.call(e, "div"), O.call(e, "[s!='']:x"), R.push("!=", oe)
            }), _ = _.length && new RegExp(_.join("|")), R = R.length && new RegExp(R.join("|")), t = ge.test(q.compareDocumentPosition), M = t || ge.test(q.contains) ? function (e, t) {
                ...
                return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !w.sortDetached && t.compareDocumentPosition(e) === n ? e === H || e.ownerDocument === B && M(B, e) ? -1 : t === H || t.ownerDocument === B && M(B, t) ? 1 : D ? ee(D, e) - ee(D, t) : 0 : 4 & n ? -1 : 1)
            } : function (e, t) {
                if (e === t)return A = !0, 0;
            ...
            if ((e.ownerDocument || e) !== H && L(e), n = n.replace(ce, "='$1']"), w.matchesSelector && F && !X[n + " "] && (!R || !R.test(n)) && (!_ || !_.test(n)))try {
                var r = O.call(e, n);
            ...
            var n = T.attrHandle[t.toLowerCase()], r = n && G.call(T.attrHandle, t.toLowerCase()) ? n(e, t, !F) : void 0;
                    ...
                    return 1 === r && 0 === i ? function (e) {
                        ...
                        if (g) {
                            ...
                            if (h = [a ? g.firstChild : g.lastChild], a && y) {
                                for (f = g, d = f[P] || (f[P] = {}), c = d[f.uniqueID] || (d[f.uniqueID] = {}), u = c[e] || [], p = u[0] === I && u[1], b = p && u[2], f = p && g.childNodes[p]; f = ++p && f && f[m] || (b = p = 0) || h.pop();)if (1 === f.nodeType && ++b && f === t) {
                                    c[e] = [I, p, b];
                                    break
                                }
                            } else if (y && (f = t, d = f[P] || (f[P] = {}), c = d[f.uniqueID] || (d[f.uniqueID] = {}), u = c[e] || [], p = u[0] === I && u[1], b = p), b === !1)for (; (f = ++p && f && f[m] || (b = p = 0) || h.pop()) && ((s ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++b || (y && (d = f[P] || (f[P] = {}), c = d[f.uniqueID] || (d[f.uniqueID] = {}), c[e] = [I, b]), f !== t)););
        ...
        return d.prototype = T.filters = T.pseudos, T.setFilters = new d, k = t.tokenize = function (e, n) {
            ...
            return (u || S(e, d))(r, t, !F, n, !t || ye.test(e) && c(t.parentNode) || t), n
    ...
    var Ee, ke = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, Se = pe.fn.init = function (e, t, n) {
        var r, i;
        if (!e)return this;
    ...
    Se.prototype = pe.fn, Ee = pe(re);
    var Ne = /^(?:parents|prev(?:Until|All))/, je = {children: !0, contents: !0, next: !0, prev: !0};
    pe.fn.extend({
        has: function (e) {
        ...
        pe.fn[e] = function (n, r) {
            ...
            return "Until" !== e.slice(-5) && (r = n), r && "string" == typeof r && (i = pe.filter(r, i)), this.length > 1 && (je[e] || (i = pe.uniqueSort(i)), Ne.test(e) && (i = i.reverse())), this.pushStack(i)
        }
    });
    var De = /\S+/g;
    pe.Callbacks = function (e) {
        ...
        Deferred: function (e) {
            ...
            if (a > 1)for (t = new Array(a), n = new Array(a), r = new Array(a); i < a; i++)o[i] && pe.isFunction(o[i].promise) ? o[i].promise().progress(u(i, n, t)).done(u(i, r, o)).fail(l.reject) : --s;
    ...
    pe.fn.ready = function (e) {
        ...
        isReady: !1, readyWait: 1, holdReady: function (e) {
            ...
            (e === !0 ? --pe.readyWait : pe.isReady) || (pe.isReady = !0, e !== !0 && --pe.readyWait > 0 || (Ae.resolveWith(re, [pe]), pe.fn.triggerHandler && (pe(re).triggerHandler("ready"), pe(re).off("ready"))))
        }
    }), pe.ready.promise = function (t) {
        if (!Ae)if (Ae = pe.Deferred(), "complete" === re.readyState || "loading" !== re.readyState && !re.documentElement.doScroll)e.setTimeout(pe.ready); else if (re.addEventListener)re.addEventListener("DOMContentLoaded", s), e.addEventListener("load", s); else {
    ...
    var _e = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, Re = new RegExp("^(?:([+-])=|)(" + _e + ")([a-z%]*)$", "i"), Oe = ["Top", "Right", "Bottom", "Left"], Me = function (e, t) {
    ...
    }, Be = /^(?:checkbox|radio)$/i, Ie = /<([\w:-]+)/, We = /^$|\/(?:java|ecma)script/i, $e = /^\s+/, ze = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|dialog|figcaption|figure|footer|header|hgroup|main|mark|meter|nav|output|picture|progress|section|summary|template|time|video";
    !function () {
    ...
    var Ge = /^(?:input|select|textarea)$/i, Ye = /^key/, Je = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, Qe = /^(?:focusinfocus|focusoutblur)$/, Ke = /^([^.]*)(?:\.(.+)|)/;
    pe.event = {
        global: {},
        add: function (e, t, n, r, i) {
            ...
            if (g) {
                ...
                }, c.elem = e), t = (t || "").match(De) || [""], s = t.length; s--;)o = Ke.exec(t[s]) || [], p = m = o[1], h = (o[2] || "").split(".").sort(), p && (u = pe.event.special[p] || {}, p = (i ? u.delegateType : u.bindType) || p, u = pe.event.special[p] || {}, d = pe.extend({
                    type: p,
                    origType: m,
                    data: r,
                    handler: n,
        ...
        remove: function (e, t, n, r, i) {
            ...
            if (g && (c = g.events)) {
                for (t = (t || "").match(De) || [""], u = t.length; u--;)if (s = Ke.exec(t[u]) || [], p = m = s[1], h = (s[2] || "").split(".").sort(), p) {
        ...
        trigger: function (t, n, r, i) {
            ...
            if (s = c = r = r || re, 3 !== r.nodeType && 8 !== r.nodeType && !Qe.test(p + pe.event.triggered) && (p.indexOf(".") > -1 && (h = p.split("."), p = h.shift(), h.sort()), a = p.indexOf(":") < 0 && "on" + p, t = t[pe.expando] ? t : new pe.Event(p, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : pe.makeArray(n, [t]), u = pe.event.special[p] || {}, i || !u.trigger || u.trigger.apply(r, n) !== !1)) {
                ...
                for (d = 0; (s = f[d++]) && !t.isPropagationStopped();)t.type = d > 1 ? l : u.bindType || p, o = (pe._data(s, "events") || {})[t.type] && pe._data(s, "handle"), o && o.apply(s, n), o = a && s[a], o && o.apply && He(s) && (t.result = o.apply(s, n), t.result === !1 && t.preventDefault());
                if (t.type = p, !i && !t.isDefaultPrevented() && (!u._default || u._default.apply(f.pop(), n) === !1) && He(r) && a && r[p] && !pe.isWindow(r)) {
    ...
    pe.extend({
        htmlPrefilter: function (e) {
            ...
            if (de.html5Clone || pe.isXMLDoc(e) || !et.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (st.innerHTML = e.outerHTML, st.removeChild(o = st.firstChild)), !(de.noCloneEvent && de.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || pe.isXMLDoc(e)))for (r = h(o), s = h(e), a = 0; null != (i = s[a]); ++a)r[a] && S(i, r[a]);
            ...
            for (var n, r, i, o, a = 0, s = pe.expando, l = pe.cache, u = de.attributes, c = pe.event.special; null != (n = e[a]); a++)if ((t || He(n)) && (i = n[s], o = i && l[i])) {
        ...
        domManip: N, detach: function (e) {
            ...
            return Pe(this, function (e) {
                ...
                if ("string" == typeof e && !nt.test(e) && (de.htmlSerialize || !et.test(e)) && (de.leadingWhitespace || !$e.test(e)) && !Xe[(Ie.exec(e) || ["", ""])[1].toLowerCase()]) {
    ...
    var vt = /alpha\([^)]*\)/i, yt = /opacity\s*=\s*([^)]*)/i, bt = /^(none|table(?!-c[ea]).+)/, xt = new RegExp("^(" + _e + ")(.*)$", "i"), wt = {
        position: "absolute",
        visibility: "hidden",
        display: "block"
    }, Tt = {
    ...
    pe.extend({
        ...
        style: function (e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                if (o = typeof n, "string" === o && (i = Re.exec(n)) && i[1] && (n = f(e, t, i), o = "number"), null != n && n === n && ("number" === o && (n += i && i[3] || (pe.cssNumber[s] ? "" : "px")), de.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), !(a && "set" in a && void 0 === (n = a.set(e, n, r)))))try {
                    l[t] = n
                } catch (e) {
                }
            }
        ...
        css: function (e, t, n, r) {
            ...
            return t = pe.cssProps[s] || (pe.cssProps[s] = H(s) || s), a = pe.cssHooks[t] || pe.cssHooks[s], a && "get" in a && (o = a.get(e, !0, n)), void 0 === o && (o = mt(e, t, r)), "normal" === o && t in Tt && (o = Tt[t]), "" === n || n ? (i = parseFloat(o), n === !0 || isFinite(i) ? i || 0 : o) : o
        }
        ...
        pe.cssHooks[t] = {
            get: function (e, n, r) {
                ...
                var i = r && ht(e);
                return F(e, n, r ? _(e, t, r, de.boxSizing && "border-box" === pe.css(e, "boxSizing", !1, i), i) : 0)
            }
        }
        ...
        if (t)return (parseFloat(mt(e, "marginLeft")) || (pe.contains(e.ownerDocument, e) ? e.getBoundingClientRect().left - ft(e, {marginLeft: 0}, function () {
        ...
        }, ct.test(e) || (pe.cssHooks[e + t].set = F)
    }), pe.fn.extend({
        css: function (e, t) {
    ...
    var kt, St, Nt = /^(?:toggle|show|hide)$/, jt = /queueHooks$/;
    ...
    var Lt, Ht, qt = pe.expr.attrHandle, Ft = /^(?:checked|selected)$/i, _t = de.getSetAttribute, Rt = de.input;
    pe.fn.extend({
        attr: function (e, t) {
        ...
        attr: function (e, t, n) {
            ...
            if (o && 1 === e.nodeType)for (; n = o[i++];)r = pe.propFix[n] || n, pe.expr.match.bool.test(n) ? Rt && _t || !Ft.test(n) ? e[r] = !1 : e[pe.camelCase("default-" + n)] = e[r] = !1 : pe.attr(e, n, ""), e.removeAttribute(_t ? n : r)
        }
    }), Ht = {
        set: function (e, t, n) {
            return t === !1 ? pe.removeAttr(e, n) : Rt && _t || !Ft.test(n) ? e.setAttribute(!_t && pe.propFix[n] || n, n) : e[pe.camelCase("default-" + n)] = e[n] = !0, n
        }
    }, pe.each(pe.expr.match.bool.source.match(/\w+/g), function (e, t) {
        var n = qt[t] || pe.find.attr;
        Rt && _t || !Ft.test(t) ? qt[t] = function (e, t, r) {
            var i, o;
            return r || (o = qt[t], qt[t] = i, i = null != n(e, t, r) ? t.toLowerCase() : null, qt[t] = o), i
        } : qt[t] = function (e, t, n) {
            if (!n)return e[pe.camelCase("default-" + t)] ? t.toLowerCase() : null
        }
    }), Rt && _t || (pe.attrHooks.value = {
        set: function (e, t, n) {
    ...
    pe.fn.extend({
        addClass: function (e) {
            ...
            if ("string" == typeof e && e)for (t = e.match(De) || []; n = this[l++];)if (i = z(n), r = 1 === n.nodeType && (" " + i + " ").replace(Pt, " ")) {
    ...
    var Bt = e.location, It = pe.now(), Wt = /\?/, $t = /(,)|(\[|{)|(}|])|"(?:[^"\\\r\n]|\\["\\\/bfnrt]|\\u[\da-fA-F]{4})*"\s*:?|true|false|null|-?(?!0\d)\d+(?:\.\d+|)(?:[eE][+-]?\d+|)/g;
    ...
    var zt = /#.*$/, Xt = /([?&])_=[^&]*/, Ut = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, Vt = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Gt = /^(?:GET|HEAD)$/, Yt = /^\/\//, Jt = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, Qt = {}, Kt = {}, Zt = "*/".concat("*"), en = Bt.href, tn = Jt.exec(en.toLowerCase()) || [];
    pe.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ...
        ajax: function (t, n) {
            function r(t, n, r, i) {
                var o, d, y, b, w, C = n;
                2 !== x && (x = 2, l && e.clearTimeout(l), c = void 0, s = i || "", T.readyState = t > 0 ? 4 : 0, o = t >= 200 && t < 300 || 304 === t, r && (b = G(f, T, r)), b = Y(f, b, T, o), o ? (f.ifModified && (w = T.getResponseHeader("Last-Modified"), w && (pe.lastModified[a] = w), w = T.getResponseHeader("etag"), w && (pe.etag[a] = w)), 204 === t || "HEAD" === f.type ? C = "nocontent" : 304 === t ? C = "notmodified" : (C = b.state, d = b.data, y = b.error, o = !y)) : (y = C, !t && C || (C = "error", t < 0 && (t = 0))), T.status = t, T.statusText = (n || C) + "", o ? m.resolveWith(p, [d, C, T]) : m.rejectWith(p, [T, C, y]), T.statusCode(v), v = void 0, u && h.trigger(o ? "ajaxSuccess" : "ajaxError", [T, f, o ? d : y]), g.fireWith(p, [T, C]), u && (h.trigger("ajaxComplete", [T, f]), --pe.active || pe.event.trigger("ajaxStop")))
            }

            "object" == typeof t && (n = t, t = void 0), n = n || {};
            var i, o, a, s, l, u, c, d, f = pe.ajaxSetup({}, n), p = f.context || f, h = f.context && (p.nodeType || p.jquery) ? pe(p) : pe.event, m = pe.Deferred(), g = pe.Callbacks("once memory"), v = f.statusCode || {}, y = {}, b = {}, x = 0, w = "canceled", T = {
                readyState: 0,
                ...
                statusCode: function (e) {
                    var t;
                    if (e)if (x < 2)for (t in e)v[t] = [v[t], e[t]]; else T.always(e[T.status]);
                    return this
                },
                abort: function (e) {
                    var t = e || w;
            ...
            if (m.promise(T).complete = g.add, T.success = T.done, T.error = T.fail, f.url = ((t || f.url || en) + "").replace(zt, "").replace(Yt, tn[1] + "//"), f.type = n.method || n.type || f.method || f.type, f.dataTypes = pe.trim(f.dataType || "*").toLowerCase().match(De) || [""], null == f.crossDomain && (i = Jt.exec(f.url.toLowerCase()), f.crossDomain = !(!i || i[1] === tn[1] && i[2] === tn[2] && (i[3] || ("http:" === i[1] ? "80" : "443")) === (tn[3] || ("http:" === tn[1] ? "80" : "443")))), f.data && f.processData && "string" != typeof f.data && (f.data = pe.param(f.data, f.traditional)), U(Qt, f, n, T), 2 === x)return T;
            u = pe.event && f.global, u && 0 === pe.active++ && pe.event.trigger("ajaxStart"), f.type = f.type.toUpperCase(), f.hasContent = !Gt.test(f.type), a = f.url, f.hasContent || (f.data && (a = f.url += (Wt.test(a) ? "&" : "?") + f.data, delete f.data), f.cache === !1 && (f.url = Xt.test(a) ? a.replace(Xt, "$1_=" + It++) : a + (Wt.test(a) ? "&" : "?") + "_=" + It++)), f.ifModified && (pe.lastModified[a] && T.setRequestHeader("If-Modified-Since", pe.lastModified[a]), pe.etag[a] && T.setRequestHeader("If-None-Match", pe.etag[a])), (f.data && f.hasContent && f.contentType !== !1 || n.contentType) && T.setRequestHeader("Content-Type", f.contentType), T.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + Zt + "; q=0.01" : "") : f.accepts["*"]);
    ...
    pe.ajaxSetup({
        ...
        if (s || "jsonp" === t.dataTypes[0])return i = t.jsonpCallback = pe.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(fn, "$1" + i) : t.jsonp !== !1 && (t.url += (Wt.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function () {
    ...
    e.rails = n = {
        ...
        handleRemote: function (r) {
            ...
            if (n.fire(r, "ajax:before")) {
                ...
                return u = {
                    type: i || "GET", data: a, dataType: l, beforeSend: function (e, i) {
                ...
                }, s && (u.xhrFields = {withCredentials: s}), o && (u.url = o), n.ajax(u)
            }
            return !1
        },
        ...
        handleMethod: function (r) {
            var i = n.href(r), o = r.data("method"), a = r.attr("target"), s = n.csrfToken(), l = n.csrfParam(), u = e('<form method="post" action="' + i + '"></form>'), c = '<input name="_method" value="' + o + '" type="hidden" />';
        ...
        blankInputs: function (t, n, r) {
            var i, o, a, s, l = e(), u = n || "input,textarea", c = t.find(u), d = {};
            return c.each(function () {
                i = e(this), i.is("input[type=radio]") ? (s = i.attr("name"), d[s] || (0 === t.find('input[type=radio]:checked[name="' + s + '"]').length && (a = t.find('input[type=radio][name="' + s + '"]'), l = l.add(a)), d[s] = s)) : (o = i.is("input[type=checkbox],input[type=radio]") ? i.is(":checked") : !!i.val(), o === r && (l = l.add(i)))
            }), !!l.length && l
        },
        ...
        if (a.attr("novalidate") === t)if (a.data("ujs:formnovalidate-button") === t) {
            if (i = n.blankInputs(a, n.requiredInputSelector, !1), i && n.fire(a, "ajax:aborted:required", [i]))return n.stopEverything(r)
    ...
    $("nav").height($(window).height()), $(window).resize(function () {
        $("nav").height($(window).height())
    });
    var e = window.location.href;
    e.indexOf("find") >= 0 || e.indexOf("people") >= 0 ? $(".link-0").addClass("active") : e.indexOf("news") >= 0 ? $(".link-1").addClass("active") : e.indexOf("product") >= 0 ? $(".link-2").addClass("active"): e.indexOf("list_with_name_and_summary") >= 0 ? $(".link-3").addClass("active") : e.indexOf("messages") >= 0 && $(".link-4").addClass("active"), $(".btn-delete").click(function () {
        var e = $(this);
        e.prev("span").remove(), e.remove()
    })
});