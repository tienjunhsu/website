(function () {
    var _ha_proid = "1001";
    var _true = true, _false = false, _encodeURI = encodeURIComponent, _o_window = window, _undefined = undefined, _o_string = String, _o_math = Math, _push = "push", _cookie = "cookie", _charAt = "charAt", _str_indexOf = "indexOf", _gaGlobal = "gaGlobal", _getTime = "getTime", _toString = "toString", _str_window = "window", _length = "length", _str_document = "document", _split = "split", _location = "location", _protocol = "protocol", _href = "href", _substring = "substring", _join = "join", _toLowerCase = "toLowerCase";
    var _hat_ = "_hat", _haq_ = "_haq", _version_ = "1.1.1", _gaUserPrefs_ = "_gaUserPrefs", _ioo_ = "ioo", _amp_ = "&", _equal_ = "=", _param_hutma = "__hutma=", _param_hutmb = "__hutmb=", _param_hutmc = "__hutmc=", _param_hutmk = "__hutmk=", _param_hutmv = "__hutmv=", _param_hutmz = "__hutmz=", _param_hutmx = "__hutmx=", _param_hutmmobile = "__hutmmobile=", _param_hb_pgid = "_hb_pgid=", _param_hbotrack = "_hbotrack=", _param_zero_hbtrack = "_zero_hbtrack=", _param_gaso = "GASO=", howbuy = "howbuy.com", hbc = "www.howbuy.com", ehbc = "www.ehowbuy.com", rc_domain = ".howbuy.com", uac_path = "/uac/ha.do", uac_uapath = "/uac/uac.do", uac_clickpath = "/uac/hbhc.do", isUacTe = false, _paramUtil_ = "_paramUtil";
    ...
    var HRegistry = function () {
        var oThis = this, _registry = [], _alphabet = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_";
    ...
    var HaCookie = function (config) {
        ...
        oThis.setDomainHashByCookie = function (domainHash) {
            var cookie = oThis.getCookie(), result = _false;
            if (cookie) {
        ...
        oThis.copyCookiePath = function (domainHash, cookiePath) {
            var _hutmParams = oThis.UTMParams, _cookiePath = _config.cookiePath;
    ...
    var PCookie = function (config) {
        var _oThis = this, _config = config;
    ...
    google_analytics_path = google_analytics_domain + "p/__hutm.gif", Ajax = function () {
        var oThis = this;
        ...
        oThis.sendByIFrame = function (param, callback) {
            ...
            if (doc.body) {
                ...
                var succes = _false, i = 0, fraLoad = function () {
                    if (!succes) {
                        try {
                            if (i > 9 || fra.contentWindow[_location].host == doc[_location].host) {
                                succes = _true;
                                setFra();
                                var win = $HGlobal[_str_window], _beforeunload = "beforeunload", _setFra = setFra;
    ...
    var GaAjax = function (config) {
        var oThis = this, _config = config, _gaCookie = new HaCookie(_config), ajax = new Ajax, paramUtil = new localParamDataUtil, _ioo = !_HTrackerFactory.getGaUserPrefs(), emptyFunction = function () {
        };
        oThis.getHowbuyAnalyticsPath = function () {
            return (window.location.protocol == "https:") ? "https://" + getUacHost("https") + uac_path : "http://" + getUacHost("http") + uac_path;
        };
        ...
        oThis.send = function (param, account, domainHash, e, d, callback) {
            var localServerMode = _config.localServerMode, location = $HGlobal[_str_document][_location];
    ...
    GaEComm.Transaction = function (orderId, affiliation, total, tax, shipping, city, state, country) {
        ...
        oThis.addItem = function (sku, name, category, price, quantity) {
            var item = oThis.getItem(sku), orderId = oThis.orderId;
            if (_undefined == item) {
    ...
    var HClient = function (detectFlash) {
        function getFlashVersion() {
            ...
            var _version_key = "$version", navigator = $HGlobal[_str_window].navigator;
        ...
        var oThis = this, _empty = "-", screen = $HGlobal[_str_window].screen, navigator = $HGlobal[_str_window].navigator;
        ...
        oThis.hashClientInfo = function () {
            var navigator = $HGlobal[_str_window].navigator, history_length = $HGlobal[_str_window].history[_length];
    ...
    var HSourceTracker = function (domainHash, processedSource, timestamp, config) {
        ...
        oThis.isIgnoredReferral = function (source) {
            var result = _false, ignoredReferral = _config.ignoredReferral;
    ...
    var HCustomVariable = function (config, domainHash, gaCookie, cache) {
        var oThis = this, _domainHash = domainHash, _equal = _equal_, _config = config, _cache = cache;
    ...
    var HCache = function () {
        ...
        var oThis = this, bind = HCreateBinder(oThis), _Cache = {}, _key = "k", _value = "v", _map_key = [_key, _value], _left_parenthesis = "(", _right_parenthesis = ")", _asterisk = "*", _exclamation = "!", _quote = "'", _special_sign = {};
    ...
    var EventTracker = function (category, tracker) {
        var oThis = this, bind = HCreateBinder(oThis);
    ...
    var HTimeTracker = function (tracker, gaAjax) {
        var oThis = this, external = $HGlobal[_str_window].external, webkitPerformance = $HGlobal[_str_window].webkitPerformance, _trackTimeRate = 10;
    ...
    GASO.getGASO = function (gaCookie) {
        var _gaso = "gaso=", result = "", url = $HGlobal[_str_document][_location].hash;
    ...
    GASO.create = function (gaso, domain) {
        ...
        var id = "_gasojs", script = $HGlobal[_str_document].createElement("script");
    ...
    GASO.load = function (config, gaCookie) {
        if (!GASO.created) {
            var _gaso = GASO.getGASO(gaCookie), arr_gaso = _gaso && _gaso.match(/^(?:\|([-0-9a-z.]{1,30})\|)?([-.\w]{10,1200})$/i);
            if (arr_gaso) {
    ...
    var HTracker = function (name, account, namespace) {
        ...
        function _notGoogleDomain() {
            _getDomain();
            var domain = config.domain, _isGoogle = domain[_str_indexOf]("www.google.") * domain[_str_indexOf](".google.") * domain[_str_indexOf]("google.");
        ...
        var oThis = this, bind = HCreateBinder(oThis), gaAjax = _undefined, config = new Config, d = _false, customVariable = _undefined, uuid = new UUID(), paramUtil = new localParamDataUtil();
        _o_window[_paramUtil_] = paramUtil;
        oThis.name = name;
        ...
        var pcookie = new PCookie(config), zeroTagMap = new zeroChannelTagMap();
        ...
        oThis.getLinkerUrl = bind("_getLinkerUrl", 52, function (targetUrl, useHash) {
            var n = targetUrl[_split]("#"), _targetUrl = targetUrl, params = oThis.getParams();
            if (params) {
        ...
        oThis.formatOtrack = function (otrackParamArray) {
            if (otrackParamArray && otrackParamArray.length == 5) {
                var _F = "-";
                var formatOtrack = otrackParamArray[0] + _F + otrackParamArray[1] + _F + otrackParamArray[2] + _F + otrackParamArray[3] + "." + otrackParamArray[4];
                return formatOtrack;
            }
            return "";
        };
        ...
        oThis.AUP = function () {
            return (window.location.protocol == "https:") ? "https://" + getUacHost("https") + uac_uapath : "http://" + getUacHost("http") + uac_uapath;
        };
        oThis.trackHowbuyUserAction = bind("_trackHowbuyUserAction", 110, function (paramJson) {
            ...
            for (var _arguments = arguments, err = 0, i = 0; i < _arguments[_length]; i++) {
                try {
                    if (typeof _arguments[i] === "function") {
                        ...
                        var name = "", o = _arguments[i][0], func = o, idx = o.lastIndexOf(".");
                        if (idx > 0) {
    ...
    _tracker_:{
        var gaq = _o_window[_haq_], isArray = _false;
    ...
    var sendByImage = function (src, callback) {
    ...
    var statClick = function (e, i) {
        i = i || {};
        if (!e || !e.tagName) {
            return;
        }
        var n = e.tagName.toLowerCase(), o = e.getAttribute("tag") || e.getAttribute("TAG");
        while (!o && e && e.tagName.toLowerCase() !== "body") {
            e = e.parentNode;
            if (e) {
                n = e.tagName.toLowerCase();
                o = e.getAttribute("tag") || e.getAttribute("TAG");
            }
        }
        if (i.pageID == "" && i.pagelevel == "" && (o == "" || o == "null" || o == null || o == undefined)) {
            return;
        }
        if (o) {
            var a = e.href || "";
            a = a.replace(/^\s+|\s+$/g, "");
            var hTag = "";
            if ("" != i.pageID && "" != i.pagelevel) {
                var pIdTid = parseInt(i.pageID) * 100000 + parseInt(o);
                hTag = parseInt(i.pagelevel) + "." + pIdTid;
            }
            if ((n == "a" || n == "area") && (!/^javascript/i.test(a.toLowerCase()) && e.getAttribute("href").substr(0, 1) != "#") && e.getAttribute("id") != "btnAddCart" && o != "71002") {
                if (a.indexOf("HTAG") < 0) {
                    var u = a.indexOf("#"), s = a.indexOf("?");
                    if (s < 0 && u > 0 || s > 0 && u > 0 && u < s) {
                        e.href = a.substr(0, u) + "?HTAG=" + hTag + "&" + a.substr(u + 1);
                    } else {
                        if (s > 0 && (u > s || u < 0)) {
                            e.href = a.substr(0, s) + "?HTAG=" + hTag + "&" + a.substr(s + 1);
                        } else {
                            e.href += "?HTAG=" + hTag;
                        }
                    }
                } else {
                    var f = a.match(/HTAG=([^\#\&]*)/i);
                    if (f && f[1]) {
                        e.href = a.replace((a.indexOf("htag") < 0 ? "HTAG=" : "htag=") + f[1], "HTAG=" + hTag);
                    }
                }
            } else {
                if (e.getAttribute("href").substr(0, 1) == "#" && e.getAttribute("href").split("#").length > 1) {
                    if (a.toLowerCase().indexOf("HTAG") < 0) {
                        var u = a.indexOf("#"), s = a.indexOf("?");
                        if (s < 0 && u > 0 || s > 0 && u > 0 && u < s) {
                            e.href = a.substr(0, u) + "?HTAG=" + hTag + "#" + a.substr(u + 1);
                        } else {
            ...
            var hTagIndex = urlParam.indexOf("&HTAG=");
            var srcParam = urlParam.substr(0, hTagIndex);
            var src = i.src + "?" + srcParam + "&HTAG=" + hTag + "&proid=" + i.proid + "&pageid=" + i.pageID + "&pagelevel=" + i.pagelevel + "&tag=" + o;
            sendByImage(src);
        }
    };
    var ucp = function () {
        var p = (window.location.protocol == "https:") ? "https://" + getUacHost("https") : "http://" + getUacHost("http");
        return p + uac_clickpath;
    };
    document.body.onclick = function (o) {
        ...
        pageId = pageId ? pageId : "";
        pagelevel = pagelevel ? pagelevel : "";
        statClick(o && o.target, {pageID: pageId, pagelevel: pagelevel, proid: _ha_proid, src: ucp()});
    };
})();
var _haq = _haq || [];
_haq.push(["_setAccount", "UA-10946093-1"]);
_haq.push(["_trackHowbuyPageview"]);
function trackHowbuyUserAction(a) {
    if (a.pageid == undefined || a.pageid == "") {
        a.pageid = _paramUtil.getPageId();
    }
    if (a.url == "" || a.url == undefined) {
        a.url = location.href;
    }
    _haq.push(["_trackHowbuyUserAction", a]);
}
function getOtrack() {
    var c = "_hbotrack";
